        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left animate-fade-in">
            ...
            <h2 className="font-display text-2xl md:text-3xl text-secondary-foreground mb-6">
              Generate Perfect Prompts, Instantly
            </h2>
            
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              Create optimized AI prompts with our intelligent prompt writer. 
              Powered by advanced AI technology, designed for maximum creativity and efficiency.
            </p>
              ...
              <div className="relative bg-card rounded-lg shadow-xl p-8 border border-border">
                <div className="aspect-square bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg flex items-center justify-center">
                  <div className="text-center">
                    <Sparkles className="w-16 h-16 text-primary mx-auto mb-4 animate-pulse-slow" />
