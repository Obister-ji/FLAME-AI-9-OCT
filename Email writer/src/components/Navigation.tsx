...
export function Navigation({ currentView, onViewChange, emailCount }: NavigationProps) {
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span className="text-muted-foreground">| Email Writer</span>
          </div>
